...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/core/basiclayer/pgflibrarygraphdrawing.code.tex,v 1.21 2012/04/05 10:04:13 tantau Exp $
...
% Their default value is 15mm (as in tikz).

\pgfgddeclareforwardedkeys{/graph drawing}{
  level distance/.graph parameter=evaluate math expression,
  level distance/.parameter initial=15mm,
  ...
  sibling distance/.parameter initial=15mm,
