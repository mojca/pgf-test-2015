...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/core/basiclayer/pgflibrarygraphdrawing.code.tex,v 1.5 2011/05/10 14:21:00 tantau Exp $
...
% Key handler /.graph drawing parameter initial
%
% #1 = an initial value
%
% Description:
...
% Note that
% 
%   /foo/.graph drawing graph parameter, /foo=5
% 
% and
% 
%   /foo/.graph drawing graph parameter, /foo/.graph drawing parameter intial=5
%   
...
\pgfkeys{
  /handlers/.graph drawing parameter initial/.code={
    {
...
\pgfgdset{
  algorithm/.graph drawing graph parameter
}
...
\def\pgfgddeclarealgorithmkey#1#2#3#4{%
  \pgfkeys{
    ...
    /graph drawing/#2/.cd,% We need the % here to avoid problems with indentation in #4
    #4%
  }%
...
% 
% #1 = a list of key declarations
% 
% Description:
% 
% Each <element> of #1 should have the form <key name>/<action>.
% This will cause the following to happen:
% 
% /graph drawing/<key name>/<action> is executed
% /tikz/<key name> is forwarded to /graph drawing/<key name>
% /tikz/graphs/<key name> is forwarded to /graph drawing/<key name>
% 
%
% Example:
%
...
% {
%   height/.graph drawing graph parameter=evaluate math expression,
%   width/.graph drawing graph parameter=evaluate math expression,
% }

\def\pgfgddeclarecommonkeys#1{%
  \let\pgf@temp\pgfutil@empty
  \foreach \pgf@gd@temp/\pgf@gd@dec in {#1} {%
...
\pgfgdset{
  orientation/.graph drawing graph parameter,
...
\pgfgddeclarecommonkeys{
  desired at/.graph drawing node parameter=coordinate
}
