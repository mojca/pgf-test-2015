...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/core/basiclayer/pgflibrarygraphdrawing.code.tex,v 1.24 2012/04/12 15:16:07 tantau Exp $
...
%
\directlua{
  local file = 'pgfgd-core-loader.lua'
  local format = 'tex'
...
\pgfgddeclareforwardedkeys{/graph drawing}{
  ...
  components go right/.style={/graph drawing/component direction=0,/graph drawing/component align=center},
  % left
  ...
  components go left/.style={/graph drawing/component direction=180,/graph drawing/component align=center},
  % up
  ...
  components go down/.style={/graph drawing/component direction=270,/graph drawing/component align=center},
  % down
  ...
  components go up/.style={/graph drawing/component direction=90,/graph drawing/component align=center},
}
...
\def\pgfgdinternalshipoutnode#1#2#3#4#5#6#7#8#9{%
  {%
    ...
    \directlua{
      texnode = pgf.graphdrawing.Interface:getBox(#8)
