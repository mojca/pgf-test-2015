...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/core/basiclayer/pgflibrarygraphdrawing.code.tex,v 1.20 2012/04/04 22:42:11 tantau Exp $
...
\pgfgddeclareforwardedkeys{/graph drawing}{
  ...
  level pre sep/.parameter initial=0.5pt,
  level post sep/.node or graph parameter=evaluate math expression,
  level post sep/.parameter initial=0.5pt,
  level sep/.style=,
  ...
  sibling pre sep/.parameter initial=0.5pt,
  sibling post sep/.node or graph parameter=evaluate math expression,
  sibling post sep/.parameter initial=0.5pt,
  sibling sep/.style=,
}
