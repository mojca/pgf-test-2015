...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/graphdrawing/tikzlibrarygraphdrawing.code.tex,v 1.11 2011/05/06 11:15:33 tantau Exp $
...
\def\pgfgdtikzedgecallback#1#2#3#4#5#6#7{%
  \draw [#3,#4,/graph drawing/.cd,#6]
     (#1\tikzparentanchor)
       to [to path={#7 -- (\tikztotarget) \tikztonodes}]
       #5
     (#2\tikzchildanchor);%
}
