...
-- @release $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/algorithms/force/pgfgd-algorithm-SpringElectricalWalshaw2000.lua,v 1.7 2012/04/18 15:28:18 tantau Exp $
...
local SpringElectricalWalshaw2000 = pgf.gd.new_algorithm_class {
  properties = {
...
-- Namespace:
require("pgf.gd.force").SpringElectricalWalshaw2000 = SpringElectricalWalshaw2000
