...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/core/basiclayer/pgflibrarygraphdrawing.code.tex,v 1.27 2012/04/15 22:28:07 tantau Exp $
...
\directlua{
  ...
  if resolvers then
    dofile(assert(resolvers.find_file(file, format), 'could not find file ' .. file))
  else
    dofile(assert(kpse.find_file(file, format), 'could not find file ' .. file))
  end
