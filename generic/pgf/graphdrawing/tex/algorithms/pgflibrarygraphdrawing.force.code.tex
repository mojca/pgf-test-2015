...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/algorithms/force/pgflibrarygraphdrawing.force.code.tex,v 1.10 2012/04/05 10:04:11 tantau Exp $
...
\pgfgddeclarealgorithmkey
  ...
  {spring electrical layout}
  {
    algorithm=Spring Electrical Hu 2006,
...
\pgfgddeclarealgorithmkey
  ...
  {spring electrical layout}
  {
    algorithm=Spring Electrical Walshaw 2000,
    spring electrical layout/cooling factor/.parameter initial=0.95,
