...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/tex/tikzlibrarygraphdrawing.code.tex,v 1.9 2012/06/22 08:12:15 tantau Exp $
...
\def\pgfgdgeneratenodecallback#1#2#3#4{%
  { \node[every generated node/.try,name={#1},shape={#2},
    /graph drawing/.cd,#3]{#4}; }
}
