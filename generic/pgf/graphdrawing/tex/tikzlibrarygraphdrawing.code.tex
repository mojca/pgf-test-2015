...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/tex/tikzlibrarygraphdrawing.code.tex,v 1.5 2012/05/14 10:27:48 tantau Exp $
...
\def\pgfgdgeneratenodecallback#1#2#3#4#5#6{%
  { \node[every generated node/.try,xshift=#4pt,yshift=#5pt,name={#1},shape=#2,
    /graph drawing/.cd,#3]{#6}; }
}
...
\tikzset{
  layout/.style={/tikz/graph drawing scope,/graph drawing/algorithm={#1}},
  graph/layout/.style={/tikz/layout={#1}},
}
