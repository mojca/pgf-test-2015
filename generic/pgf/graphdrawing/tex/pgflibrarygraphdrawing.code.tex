...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/tex/pgflibrarygraphdrawing.code.tex,v 1.24 2012/11/26 21:44:32 tantau Exp $
...
\def\use@@gdlibrary#1{%
  ...
  \pgfutil@for\pgf@temp:=\pgf@list\do{%
    ...
    \else
    \directlua{
      if      not pcall(require, 'pgf.gd.\pgf@temp.library')
          and not pcall(require, 'pgf.gd.\pgf@temp')
          and not pcall(require, '\pgf@temp.library')
          and not pcall(require, '\pgf@temp') then
        error("Graph drawing library \pgf@temp\ not found")
      end
      }
    \fi
  }%
