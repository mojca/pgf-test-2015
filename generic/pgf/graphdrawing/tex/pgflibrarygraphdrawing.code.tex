...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/tex/pgflibrarygraphdrawing.code.tex,v 1.7 2012/04/19 13:58:46 tantau Exp $
...
\pgfgddeclareforwardedkeys{/graph drawing}{
  ...
  node pre sep/.node or graph parameter=evaluate math expression,
  node pre sep/.parameter initial=.333em,
  node post sep/.node or graph parameter=evaluate math expression,
