...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/tex/pgflibrarygraphdrawing.code.tex,v 1.13 2012/05/14 10:27:48 tantau Exp $
...
\directlua{
  ...
  require 'pgf.gd.lib.preload'           % Now preload the standrad libs
...
\def\pgfgdgraphparameter#1#2{%
  \pgfkeysaddvalue{/graph drawing/graph parameters}{}{['\luaescapestring{#1}']=#2,}%
}
\def\pgfgdnodeparameter#1#2{%
  \pgfkeysaddvalue{/graph drawing/node parameters}{}{['\luaescapestring{#1}']=#2,}%
}
\def\pgfgdedgeparameter#1#2{%
  \pgfkeysaddvalue{/graph drawing/edge parameters}{}{['\luaescapestring{#1}']=#2,}%
}
...
\def\pgf@gd@steal#1#2{%
  \directlua{pgf.gd.control.TeXInterface.setGraphParameterDefault('\luaescapestring{#1}',#2)}%
}
...
\def\pgf@lib@gd@parse@orient@final#1:#2:#3\pgf@stop#4{%
  ...
  \ifx\pgf@temp\pgfutil@empty
    \edef\pgf@marshal{\noexpand\pgfgdnodeparameter{/graph drawing/#4}{{\pgfmathresult,#3}}}%
  \else%
    \edef\pgf@marshal{\noexpand\pgfgdgraphparameter{/graph drawing/#4}{{\pgfmathresult,#1,#3}}}%
  \fi%
  \pgf@marshal%
}
