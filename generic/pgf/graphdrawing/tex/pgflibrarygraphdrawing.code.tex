...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/tex/pgflibrarygraphdrawing.code.tex,v 1.32 2013/03/15 15:04:43 tantau Exp $
...
\directlua{
  function pgf_lookup_and_require(name)
    local function lookup(name)
      ...
      if kpse.find_file(sub, 'clua') then
        require(name)
        return true
      end
    end
