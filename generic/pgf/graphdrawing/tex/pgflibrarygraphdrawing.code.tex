...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/tex/pgflibrarygraphdrawing.code.tex,v 1.30 2013/03/03 22:13:12 tantau Exp $
...
\def\use@@gdlibrary#1{%
  ...
  \pgfutil@for\pgf@temp:=\pgf@list\do{%
    ...
    \else
      \pgfutil@IfFileExists{\directlua{tex.print((('pgf.gd.\pgf@temp.library'):gsub('\pgfgdampersand.','/')))}.lua}
      {\directlua{require 'pgf.gd.\pgf@temp.library'} }
      {
      \pgfutil@IfFileExists{\directlua{tex.print((('pgf.gd.\pgf@temp.library'):gsub('\pgfgdampersand.','/')))}.so}
      {\directlua{require 'pgf.gd.\pgf@temp.library'} }
      {
        \pgfutil@IfFileExists{\directlua{tex.print((('pgf.gd.\pgf@temp'):gsub('\pgfgdampersand.','/')))}.lua}
        {\directlua{require 'pgf.gd.\pgf@temp'} }
        {
        \pgfutil@IfFileExists{\directlua{tex.print((('pgf.gd.\pgf@temp'):gsub('\pgfgdampersand.','/')))}.so}
        {\directlua{require 'pgf.gd.\pgf@temp'} }
        {
          \pgfutil@IfFileExists{\directlua{tex.print((('\pgf@temp.library'):gsub('\pgfgdampersand.','/')))}.lua}
          {\directlua{require '\pgf@temp.library'} }
          {
          \pgfutil@IfFileExists{\directlua{tex.print((('\pgf@temp.library'):gsub('\pgfgdampersand.','/')))}.so}
          {\directlua{require '\pgf@temp.library'} }
          {
            \pgfutil@IfFileExists{\directlua{tex.print((('\pgf@temp'):gsub('\pgfgdampersand.','/')))}.lua}
            {\directlua{require '\pgf@temp'} }
            {
            \pgfutil@IfFileExists{\directlua{tex.print((('\pgf@temp'):gsub('\pgfgdampersand.','/')))}.so}
            {\directlua{require '\pgf@temp'} }
            {
