...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/graphdrawing/tex/pgflibrarygraphdrawing.trees.code.tex,v 1.4 2012/04/20 10:59:44 tantau Exp $
...
\pgfgddeclareforwardedkeys{/graph drawing}{
  ...
  root is first node/.graph parameter=boolean,
  root is first node/.default=true,
  root/.node parameter=boolean,
  root/.default=true,
  edge priority method/.graph parameter=string,
