...
%
% $Id: pgflibraryluamath.code.tex,v 1.15 2014/08/16 14:48:20 cfeuersaenger Exp $
%
...
\pgfkeys{
	/pgf/trig format/deg/.add code={}{\directlua{pgfluamathfunctions.setTrigFormat("deg")}},
	/pgf/trig format/rad/.add code={}{\directlua{pgfluamathfunctions.setTrigFormat("rad")}},
}
