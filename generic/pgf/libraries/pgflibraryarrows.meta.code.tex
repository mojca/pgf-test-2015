...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibraryarrows.meta.code.tex,v 1.7 2013/09/30 21:28:45 tantau Exp $
...
\pgfkeys{
  ...
  cap angle/.code={%
    ...
    \pgfmathtan@{\pgf@x}%
    \pgfmathreciprocal@{\pgfmathresult}%
    \pgf@x\pgfmathresult\pgflinewidth%
    \pgf@x.5\pgf@x%
    \expandafter\pgfarrowsaddtooptions\expandafter{\expandafter\pgfarrowlength\the\pgf@x}
  }
}
  ...
  drawing code = {
    ...
    {%
      ...
      \ifdim\pgf@ya<\pgf@yb%
        ...
        \pgf@xb\pgf@ya%
        \pgfpathlineto{\pgfpointpolar{+\pgf@xb}{+1pt}}
