...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibraryarrows.meta.code.tex,v 1.3 2013/09/24 16:23:31 tantau Exp $
...
\pgfdeclarearrow{
  ...
  setup code = {
    ...
    % The hull:
    \pgfarrowshullpoint{\pgfarrowlength\ifpgfarrowroundjoin\else\ifpgfarrowharpoon\advance\pgf@x by\pgf@xa\fi\fi}{\ifpgfarrowharpoon-.5\pgfarrowlinewidth\else0pt\fi}%
    \pgfarrowshullpoint{\pgfarrowinset}{.5\pgfarrowwidth}%
    \ifpgfarrowharpoon\else
    \pgfarrowshullpoint{\pgfarrowinset}{-.5\pgfarrowwidth}%
    \fi
...
\pgfdeclarearrow{
  ...
  setup code = {
    ...
    \else%
      ...
      \else
        \pgfarrowshullpoint{\pgfarrowlength\advance\pgf@x
          by\pgf@xc\advance\pgf@x by\pgf@xa}{0pt}%
      \fi%
    \fi
    \pgfarrowshullpoint{.5\pgfarrowlinewidth}{.5\pgfarrowwidth\advance\pgf@y by.5\pgfarrowlinewidth}%
    \pgfarrowshullpoint{-.5\pgfarrowlinewidth}{.5\pgfarrowwidth\advance\pgf@y by.5\pgfarrowlinewidth}%
    \ifpgfarrowharpoon
      \pgfarrowshullpoint{-.5\pgfarrowlinewidth}{-.5\pgfarrowlinewidth}%
    \else%
...
\pgfdeclarearrow{
  ...
  setup code = {
    ...
    \pgfarrowssettipend{\pgfarrowlength}
    % The hull:
    \pgfarrowshullpoint{\pgfarrowlength}{.25\pgfarrowwidth}
    \pgfarrowshullpoint{.75\pgfarrowlength}{.5\pgfarrowwidth}
    \pgfarrowshullpoint{.25\pgfarrowlength}{.5\pgfarrowwidth}
    \pgfarrowshullpoint{0pt}{.25\pgfarrowwidth}
    \ifpgfarrowharpoon%
...
\pgfkeys{
  ...
  <-> /.tip           = {To[sep]},
  Bar /.tip           = {Square Hooks[length=0pt]},
  Bracket /.tip       = {Square Hooks[inset=0pt,length=1pt 1.25]},
}
