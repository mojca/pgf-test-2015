...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibraryarrows.code.tex,v 1.14 2013/09/19 22:34:34 tantau Exp $


% The old triangles:

\pgfkeys{
  triangle 90 /.tip           = {Stealth[length=3pt 2.707106, angle'=90, inset=0pt]}, 
  triangle 90 reversed /.tip  = {triangle 90[reversed]},
  triangle 60 /.tip           = {Stealth[length=3.897114pt 3.448557, angle'=60, inset=0pt]}, 
  triangle 60 reversed /.tip  = {triangle 60[reversed]},
  triangle 45 /.tip           = {Stealth[length=4.619398pt 4.116261, angle'=45, inset=0pt]}, 
  triangle 45 reversed /.tip  = {triangle 45[reversed]},
  open triangle 90 /.tip           = {triangle 90[open]},
  open triangle 90 reversed /.tip  = {triangle 90[open, reversed]},
  open triangle 60 /.tip           = {triangle 60[open]},
  open triangle 60 reversed /.tip  = {triangle 60[open, reversed]},
  open triangle 45 /.tip           = {triangle 45[open]},
  open triangle 45 reversed /.tip  = {triangle 45[open, reversed]},
}
