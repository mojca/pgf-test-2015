...
\pgfooclass{polar transformer}
{
  ...
  \method direction(#1) {%
    ...
    \else%
      ...
      \else
        \ifx\pgf@dv@polar@to@radius\pgf@dv@polar@from@radius%
          \pgfkeysgetvalue{/data point/\pgfoovalueof{angle}}\pgf@dv@polar@to@angle
          \ifx\pgf@dv@polar@to@angle\relax
          \else
            \ifx\pgf@dv@polar@to@angle\pgf@dv@polar@from@angle%
            % do nothing
            \else%
              % Output vector that it orthogonal to start angle:
              \pgfdvmathenter{\pgf@dv@val}{\pgf@dv@from@angle}%
              \pgfdvmathexitbyscientificformat{\pgf@dv@from@angle}{\pgf@dv@val}%
              \pgfdvmathenter{\pgf@dv@val}{\pgf@dv@to@angle}%
              \pgfdvmathexitbyscientificformat{\pgf@dv@to@angle}{\pgf@dv@val}%
