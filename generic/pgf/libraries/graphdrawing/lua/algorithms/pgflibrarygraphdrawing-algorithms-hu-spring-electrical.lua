...
-- @release $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/graphdrawing/lua/algorithms/pgflibrarygraphdrawing-algorithms-walshaw-spring-electrical.lua,v 1.8 2011/05/05 20:22:55 jannis-pohlmann Exp $
...
--
function drawGraphAlgorithm_hu_spring_electrical(graph)
  ...
  local C = tonumber(graph:getOption('spring constant')) or 0.01 * 10
  local iterations = tonumber(graph:getOption('maximum iterations')) or 500
  local t = tonumber(graph:getOption('temperature')) or 0.9 
  local tol = tonumber(graph:getOption('tolerance')) or 0.01
