...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/graphs/tikzlibrarygraphs.code.tex,v 1.6 2010/11/30 20:46:45 tantau Exp $
...
\tikzset{
  ...
  default edge operator/.initial=flow,
...
\tikzset{
  graphs/use existing nodes/.is if=tikz@lib@graph@all
}
...
\def\tikz@lib@graph@start@group@opt[#1]{%
  \pgfkeys{/tikz/graphs/.cd,@operators=,every group/.try,#1}%
...
\def\tikz@lib@graph@node@opt[#1]#2[\pgf@stop{%
  ...
  \iftikz@lib@graph@use@list%
    ...
    \tikz@lg@temp%
  \else%
    \ifx\tikz@lib@graph@name@only\tikz@lib@graph@underscoretext%
      \global\advance\tikz@fig@count by1\relax
      \let\tikz@lib@graph@node@text\pgfutil@empty%
    ...
    \expandafter\ifx\csname tikz@lib@graph@def@\tikz@lib@graph@name@only\endcsname\relax%
      {%
        ...
        {\tikzset{/tikz/graphs/.cd,source,target,#1}\pgfkeysvalueof{/tikz/graphs/@operators}}%
        {%
          \tikz@lg@init@color{\tikz@lib@graph@name}{\tikz@lgc@all@true\tikz@lgc@source@true\tikz@lgc@target@true}%
          \iftikz@lib@graph@all%
            \tikzset{/tikz/graphs/.cd,#1}\pgfkeysvalueof{/tikz/graphs/@operators}%
          \else%
...
\def\tikz@lib@graph@underscoretext{_}
...
\tikzset{
  ...
  graphs/math nodes/.style={/tikz/graphs/typeset=$\tikzgraphnodetext$},
  graphs/empty nodes/.style={/tikz/graphs/typeset=},
  graphs/typeset=\tikzgraphnodetext
}
...
\tikzset{
  graphs/as/.code=\def\tikz@lib@graph@as{#1}%
}
...
\tikzset{
  graphs/bipartite/.style 2 args={operator={
    \def\tikz@lg@shoreb{#2}%
    \tikzlibgraphforeachcolorednode{#1}\tikz@lib@graph@bipartite@outer
  }},
  graphs/bipartite/.default={target'}{source'}
}
...
\tikzset{
  graphs/clique/.style={operator={
      \tikzlibgraphpreparecolor{#1}\c@pgf@counta{tikz@lg}%
      \tikz@lg@clique@loop%
    }},
  graphs/clique/.default=all
}
...
\tikzset{
  graphs/induced independent set/.style={operator={
  ...
  graphs/induced independent set/.default=all
}
...
\tikzset{
  graphs/path/.style={operator={%
      \let\tikz@lg@prev\relax%
        \tikzlibgraphforeachcolorednode{#1}\tikz@lib@graph@path@do%
  }},   
  graphs/path/.default=all,
  graphs/induced path/.style={operator={induced independent set=#1},operator={path={#1}}},
  graphs/induced path/.default=all,
}
...
\tikzset{
  ...
  graphs/cycle/.default=all,
  graphs/induced cycle/.style={operator={induced independent set=#1},operator={cycle={#1}}},
  graphs/induced cycle/.default=all,
}
...
\tikzset{
  graphs/flow/.style 2 args={operator=%
    {%
      \tikzlibgraphpreparecolor{#1}\c@pgf@counta{tikz@lg}
      \c@pgf@countb=0\relax%
      \let\tikz@lg@prev\relax
      \tikzlibgraphforeachcolorednode{#2}\tikz@lib@graph@flow@do%
      \tikz@lib@graph@flow@rest%
    }%
  },
  graphs/flow/.default={target'}{source'}
}
...
\tikzset{
  graphs/matching/.style 2 args={operator=
    {%
      \tikzlibgraphpreparecolor{#1}\c@pgf@counta{tikz@lg}
      \c@pgf@countb=0\relax%
      \tikzlibgraphforeachcolorednode{#2}\tikz@lib@graph@matching@do%
    }%
  },
  graphs/matching/.default={target'}{source'}
}
...
\tikzset{graphs/placement/.cd,
  compute position/.code=,
  place/.code={%
...
\tikzset{graphs/.cd,
  ...
  grow right/.style={chain shift/.initial={(#1,0)}},
  grow right/.default=1,
  grow left/.style={chain shift/.initial={(-#1,0)}},
  grow left/.default=1,
  grow up/.style={chain shift/.initial={(0,#1)}},
  grow up/.default=1,
  grow down/.style={chain shift/.initial={(0,-#1)}},
  grow down/.default=1,
  branch right/.style={group shift/.initial={(#1,0)}},
  branch right/.default=1,
  branch left/.style={group shift/.initial={(-#1,0)}},
  branch left/.default=1,
  branch up/.style={group shift/.initial={(0,#1)}},
  branch up/.default=1,
  branch down/.style={group shift/.initial={(0,-#1)}},
...
\tikzset{graphs/.cd,
  ...
  clockwise/.style={
    circular,
    group polar shift/.initial={(-360/#1:0)}
  },
  clockwise/.default=\tikz@lib@graph@node@n,
  counterclockwise/.style={
    circular,
    group polar shift/.initial={(360/#1:0)}
  },
  counterclockwise/.default=\tikz@lib@graph@node@n,
  chain polar shift/.initial={(0:1cm)},
  group polar shift/.initial={(60:0)},
  n/.store in=\tikz@lib@graph@node@n,
  n=1,
  m/.store in=\tikz@lib@graph@node@m,
  m=1,
  radius/.initial=1cm,
  phase/.initial=90,
}
