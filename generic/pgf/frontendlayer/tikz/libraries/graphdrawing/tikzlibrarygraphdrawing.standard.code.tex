...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/graphdrawing/tikzlibrarygraphdrawing.standard.code.tex,v 1.2 2011/05/02 02:40:18 jannis-pohlmann Exp $
...
\tikzgraphsset{
  ...
  %
  graph drawing/register edge math key=natural length,
  graph drawing/register edge key=stiffness
}
