...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/graphdrawing/tikzlibrarygraphdrawing.code.tex,v 1.9 2011/05/02 03:36:23 jannis-pohlmann Exp $
...
% Description:
%
% The standard tree algorithm layouts an input tree. The node
% parameter ``root'' is required to set the root node, whereas the
% optional parameter ``tree scale'' defines a local scaling of the
% tree. 
%
% Example
%
