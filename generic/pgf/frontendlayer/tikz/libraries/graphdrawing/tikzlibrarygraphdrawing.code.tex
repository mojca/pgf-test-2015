...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibrarygraphdrawing.code.tex,v 1.0 2008/01/09 17:57:16 tantau Exp $
...
\tikzgraphsset{
  ...
  graph drawing/register math key=tree scale  
}
