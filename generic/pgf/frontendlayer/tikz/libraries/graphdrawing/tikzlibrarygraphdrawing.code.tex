...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/graphdrawing/tikzlibrarygraphdrawing.code.tex,v 1.6 2011/05/02 02:38:31 jannis-pohlmann Exp $
...
\tikzgraphsset{
  ...
  register node coordinate key/.style={
    /tikz/graphs/#1/.code={
      \expandafter\tikz@scan@one@point\expandafter\pgf@process##1
      \pgfmathsetmacro{\tikz@gd@temp@x}{\the\pgf@x}
      \pgfmathsetmacro{\tikz@gd@temp@y}{\the\pgf@y}
      \def\tikz@gd@temp{{\tikz@gd@temp@x}{\tikz@gd@temp@y}}
      \edef\tikz@gd@marshal{\noexpand\pgfkeys{/tikz/graphs/graph drawing/@node@options/.append={#1}{\noexpand\tikz@gd@temp}}}%
      \tikz@gd@marshal%
    }
  },
