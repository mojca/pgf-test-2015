...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.34 2011/02/27 22:50:38 tantau Exp $
      ...
      \scope[/tikz/data visualization/.cd,every ticks/.try,every #1 ticks/.try,#3]%
        ...
        \foreach \tikz@dv@tick@pos in \tikz@dv@at@list 
        {
          ...
          \else
            ...
            \scope[data visualization/ticks layer] \draw [/tikz/data visualization/styling] (\tikz@dv@min@tick) -- (\tikz@dv@max@tick); \endscope
            \iftikz@dv@min@tick@node \scope[data visualization/ticks node layer] \path [/tikz/data visualization/styling] (\tikz@dv@min@tick) \tikz@dv@handle@tick{\tikz@dv@min@anchor}; \endscope \fi
            \iftikz@dv@max@tick@node \scope[data visualization/ticks node layer] \path [/tikz/data visualization/styling] (\tikz@dv@max@tick) \tikz@dv@handle@tick{\tikz@dv@max@anchor}; \endscope\fi
          \fi      
        }
      \endscope
    }
