...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.37 2011/03/08 22:38:39 tantau Exp $
...
\tikzdatavisualizationset{visualizer options/.cd,
  @set/.style 2 args={
    /tikz/data visualization/visualizers/\tikz@visualizer/styling/.append style={,/utils/exec={\let\tikz@dv@plot@handler=#1\tikzdatavisualizationset{#2}}}
  },
      ...
      node style={%
        ...
        append after command={
          \bgroup
            ...
            (\tikzlastnode) edge [every pin edge] (label visualizer coordinate)
          \egroup%
      }},
      ,#1}},
...
\tikzdatavisualizationset{
  new axis system={school book axes}{%
    ...
    x axis={
      ...
      padding=0.75em,
      visualize label={school book axes/visualize x axis label},
    },
    y axis={
      include value=0,
      scaling=0 at 0 and \pgfkeysvalueof{/tikz/data visualization/school book axes/unit} at 1cm,
      ...
      ticks={step=\pgfkeysvalueof{/tikz/data visualization/school book axes/unit}},
      padding=0.75em,
      visualize label={school book axes/visualize y axis label}
    }
  }{%
    standard labels
  }{%
  ...
  % Basic unit 
  % 
  school book axes/unit/.initial=1,
}
