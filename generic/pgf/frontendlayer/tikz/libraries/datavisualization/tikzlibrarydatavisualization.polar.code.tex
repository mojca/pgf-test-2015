...
\tikzdatavisualizationset{
  ...
  @visualize clean radius axis/.style n args={5}{
    radius axis={
      ...
      visualize axis={angle
        axis={goto=#1},high=max,low=0,style={black,line cap=rect,#4}},
      visualize ticks={
        style={black,#4},
        common={angle axis={goto=#1}, direction axis=angle axis},
        major={tick text at #2,#3=0,#5}
      }
    }
  },
    ...
    /tikz/data visualization/@make axes/.style={
      ...
      angle axis={
        ...
        visualize ticks={common={radius axis={goto=padded max},direction
            axis=radius axis},major={low=0,tick text at high}},
  ...
  inner ticks/.style={
    /tikz/data visualization/@make axes/.style={
      ...
      angle axis={
        visualize axis={radius axis={goto=padded max},low=min,high=max},
        visualize ticks={common={radius axis={goto=padded max},direction
            axis=radius axis},major={high=0,tick text at high}},
        visualize grid={common={direction axis=radius axis},low=0,high=padded max},
      }
    },
    /tikz/data visualization/@which radius axes at=@inner radius axes at,
  ...
  clean/.style={
    /tikz/data visualization/@make axes/.style={
      ...
      angle axis={
        ...
        visualize axis={radius axis={goto=padded max}, style={black, line cap=rect}, low=min,high=max},
        visualize ticks={common={radius axis={goto=padded max}, direction axis=radius axis},style={draw=black},major={low=0,tick text at high}},
