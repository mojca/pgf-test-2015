...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.106 2013/06/24 11:49:06 tantau Exp $
...
\tikzoption{pos}{\pgfmathsetmacro\tikz@time{#1}}
...
\def\tikz@collect@label@onpath#1node{%
  ...
  \tikz@nodes@encounteredfalse%
  \let\tikz@collect@cont#1
  \tikz@collect@label@scan}
\newif\iftikz@nodes@encountered
