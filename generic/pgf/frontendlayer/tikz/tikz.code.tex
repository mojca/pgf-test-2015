...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.112 2013/07/11 14:29:42 tantau Exp $
...
\def\tikz@nodes@scan{%
  ...
  {\pgfutil@ifnextchar({\tikz@nodes@name}%
    {\pgfutil@ifnextchar[{\tikz@nodes@opt}%
      ...
      {\PackageError{tikz}{Nodes must have a (possibly empty) label text}{}%
        \tikz@fig@main{}}}}}}%}}
