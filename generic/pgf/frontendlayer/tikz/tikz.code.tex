...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.105 2013/06/21 14:23:49 tantau Exp $
...
\def\tikz@installcommands{%
  ...
  %
  \iftikz@handle@active@code\else\tikz@deactivatthings\fi%
  %
...
\def\tikz@collect@arg#1#2{%
  \iftikz@handle@active@nodes%
    \expandafter\def\expandafter\tikz@collected@onpath\expandafter{\tikz@collected@onpath{\scantokens{#2}}}%
  \else%
    \expandafter\def\expandafter\tikz@collected@onpath\expandafter{\tikz@collected@onpath{#2}}%
  \fi%
  #1%
      ...
      \bgroup%
        ...
        \pgfinterruptpicture%
          ...
          \bgroup%
            ...
            \tikz@halign@check%
            \iftikz@handle@active@code\tikz@orig@shorthands\fi%
            \ignorespaces%
}
