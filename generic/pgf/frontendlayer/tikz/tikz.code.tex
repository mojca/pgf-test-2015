...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.129 2013/08/05 18:22:47 tantau Exp $
      ...
      append after command = {%  
        \bgroup
          ...
          node [every label,
                tikz@label@angle = #2,
                #1,
                tikz@label@post = \tikz@label@distance] {\iftikz@handle@active@nodes\expandafter\scantokens\fi{#3}}
...
\tikzset{>> sep/.store in=\tikzdoublearrowsep}%<<
\def\tikzdoublearrowsep{\the\pgflinewidth-\pgfinnerlinewidth}
...
\def\tikz@set@pointed#1#2{%
  ...
  {%
    ...
    \pgfarrowsdeclaredouble[\noexpand\tikzdoublearrowsep]{tikzs@<<@#2}{tikze@>>@#2}{#1}{#2}%<<
    \pgfsetarrowoptions{tikze@>>@#2}{\tikzdoublearrowsep}
    \pgfarrowsdeclaredouble[\noexpand\tikzdoublearrowsep]{tikzs@>>@#2}{tikze@<<@#2}{tikzs@>@#2}{tikze@<@#2}%<<
    \pgfsetarrowoptions{tikze@<<@#2}{\tikzdoublearrowsep}
    \pgfarrowsdeclarecombine*[\noexpand\tikzdoublearrowsep]{tikzs@< <@#2}{tikze@> >@#2}{tikzs@<@#2}{tikze@>@#2}{tikzs@<@#2}{tikze@>@#2}%
    \pgfsetarrowoptions{tikze@> >@#2}{\tikzdoublearrowsep}
    \pgfarrowsdeclarecombine*[\noexpand\tikzdoublearrowsep]{tikzs@> >@#2}{tikze@< <@#2}{tikzs@>@#2}{tikze@<@#2}{tikzs@>@#2}{tikze@<@#2}%
    \pgfsetarrowoptions{tikze@< <@#2}{\tikzdoublearrowsep}
...
\long\def\tikz@fig@scan@options[#1]{\tikz@enable@node@quotes\tikzset{#1}\ifx\tikz@node@content\relax\expandafter\tikz@@scan@fig\else\tikz@expand@node@contents\fi}%
