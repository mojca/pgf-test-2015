...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.138 2013/09/30 18:30:15 tantau Exp $
...
\tikzset{
  tips/.is choice,
  tips/.default=true,
  tips/true/.code=\tikz@addmode{\tikz@mode@tipstrue},
  tips/false/.code=\tikz@addmode{\tikz@mode@tipsfalse},
  tips/none/.code=\tikz@addmode{\tikz@mode@tipsfalse},
}
\tikzoption{fill}[]{%
  \edef\tikz@temp{#1}%
  \ifx\tikz@temp\tikz@nonetext%
...
\tikzset{
  ...
  transform shape nonlinear/false/.code=\def\tikz@nlt{\pgftransformapproximatenonlineartranslation},
