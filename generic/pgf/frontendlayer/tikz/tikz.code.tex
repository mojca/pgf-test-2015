...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.93 2012/04/01 22:06:08 tantau Exp $
...
\let\tikz@child@group@callback\relax
  ...
  \setbox\tikz@figbox=\hbox\bgroup%
    ...
    \hbox\bgroup\bgroup%
        \pgfinterruptpath%
          \pgfscope%
            \let\tikz@transform=\pgfutil@empty%
            \tikz@child@count@callback{\the\tikznumberofcurrentchild}{1}%
...
\def\tikz@child@count@callback#1#2{}%
