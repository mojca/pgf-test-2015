...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmodulebending.code.tex,v 1.6 2013/09/17 17:34:00 tantau Exp $
...
\pgfkeys{
  /pgf/@arrows/flex/.code=\pgfarrowsaddtooption{\pgf@bend@set@rigidity{#1}},
  /pgf/@arrows/flex/.default=1,
  /pgf/@arrows/bend/.code=\pgfarrowsaddtooption{\pgf@bend@set@rigidity{-1}}
}

\def\pgf@bend@set@rigidity#1{\def\pgf@arrows@the@rigidity{#1}\global\pgf@shorten@curvedtrue}
