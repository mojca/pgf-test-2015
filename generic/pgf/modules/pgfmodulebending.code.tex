...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmodulebending.code.tex,v 1.5 2013/09/09 10:05:17 tantau Exp $
...
\pgfkeys{
  /pgf/graceful arrows/.code=\pgf@shorten@curvedtrue,
  /pgf/arrows/flex/.code=\pgfarrowsaddtooption{\def\pgf@arrows@the@rigidity{#1}},
  /pgf/arrows/flex/.default=1,
  /pgf/arrows/bend/.code=\pgfarrowsaddtooption{\def\pgf@arrows@the@rigidity{-1}},
}

\pgf@shorten@curvedtrue

\def\pgf@arrows@ridig@mode@rigid{0}
\def\pgf@arrows@ridig@mode@tangent{1}
\def\pgf@arrows@ridig@mode@bent{2}
