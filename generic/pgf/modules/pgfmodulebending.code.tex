...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmodulebending.code.tex,v 1.13 2013/09/21 10:45:44 tantau Exp $
...
\pgfkeys{
  /pgf/arrow keys/flex/.code=\pgfarrowsaddtooptions{\pgf@bend@set@rigidity{#1}},
  /pgf/arrow keys/flex/.default=1,
  /pgf/arrow keys/bend/.code=\pgfarrowsaddtooptions{\pgf@bend@set@rigidity{-1}}
}

\def\pgf@bend@set@rigidity#1{\pgf@arrows@the@rigidity#1pt\pgf@shorten@curvedtrue}
...
\def\pgf@draw@curved#1#2{%
  ...
  {%
    ...
    \ifx\pgf@arrow@bending@mode\pgfutil@empty\ifdim\pgf@arrows@the@rigidity<0pt\pgf@arrows@the@rigidity-\pgf@arrows@the@rigidity\fi\fi%
    % do swap:
    {%
...
\def\pgf@arrow@drawer@rigid@or@bend#1#2{% rigid start, rigid end, bending mode
  \ifdim\pgf@arrows@the@rigidity<0pt%
    ...
    {%
      ...
      \pgfscope%
        ...
        \csname pgf@ar@code@\pgf@arrow@id\endcsname%
      \endpgfscope%
    }%
