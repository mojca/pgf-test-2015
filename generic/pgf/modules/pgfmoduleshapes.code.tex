...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleshapes.code.tex,v 1.25 2013/06/18 20:49:40 tantau Exp $
...
\expandafter\def\csname pgf@sh@np@current page\endcsname{%
  \def\southwest{\pgfqpoint{\hoffset}{\voffset}}%
  \def\northeast{\pgfpointadd{\pgfqpoint{\paperwidth}{\paperheight}}{\pgfqpoint{\hoffset}{\voffset}}}%
}
