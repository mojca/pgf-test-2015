...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduledatavisualization.code.tex,v 1.48 2014/03/21 19:52:38 tantau Exp $
...
\pgfooclass{scaling mapper}
{
  ...
  \method set in to(#1) {
    ...
    \ifx\pgf@temp\pgf@min@text
      ...
      \pgfkeyslet{/data point/\pgfoovalueof{in}/is min or max}\pgf@min@text%
    \else
      \ifx\pgf@temp\pgf@max@text
        \pgf@dv@lib@set@mm%
        \let\pgf@dv@value\pgfdvmax
        \pgfkeyslet{/data point/\pgfoovalueof{in}/is min or max}\pgf@max@text%
      \else
