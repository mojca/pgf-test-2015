...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmodulenonlineartransformations.code.tex,v 1.2 2013/09/17 17:34:00 tantau Exp $
...
\def\pgftransformapproximatenonlineartranslation{%
...
\def\pgftransformapproximatenonlineartransformation{%
  \ifx\pgf@nlt@list\pgfutil@empty%
  \else%
