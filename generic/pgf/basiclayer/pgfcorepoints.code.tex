...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorepoints.code.tex,v 1.23 2013/06/25 18:35:45 tantau Exp $
...
\def\pgfpointlineattime#1#2#3{%
  ...
  \advance\pgf@x by \pgf@temp\pgf@xa\relax%
  \advance\pgf@y by \pgf@temp\pgf@ya\relax%  
  \ignorespaces}
