...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorescopes.code.tex,v 1.42 2013/09/19 22:34:34 tantau Exp $
...
\def\pgf@after@text{%
  ...
  %
  \pgftransformapproximatenonlineartransformation%
  % Protocol sizes:
