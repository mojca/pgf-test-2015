...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorepathusage.code.tex,v 1.16 2013/09/17 20:22:03 tantau Exp $
...
\pgfkeys{
  ...
  /pgf/@arrows/flex/.code=\pgferror{You need to say \string\usetikzlibrary{bending} for flexing and bending arrows},
  /pgf/@arrows/bend/.code=\pgferror{You need to say \string\usetikzlibrary{bending} for flexing and bending arrows},
  /pgf/@arrows/quick/.code=\pgfarrowsaddtooptions{\pgf@shorten@curvedfalse},
}
...
\def\pgf@prep@straightend{%
  \pgfpointlineatdistance{\pgf@path@shortening@distance}{\pgfpointlastonpath}{\pgfpointsecondlastonpath}%
  \pgf@xa\pgf@x%
  \pgf@ya\pgf@y%
}
...
\def\pgf@prep@straightstart{%
  \pgfpointlineatdistance{\pgf@path@shortening@distance}{\pgfpointfirstonpath}{\pgfpointsecondonpath}%
  \pgf@xa\pgf@x%
  \pgf@ya\pgf@y%
}
