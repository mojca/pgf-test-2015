...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorearrows.code.tex,v 1.37 2013/10/02 14:27:57 tantau Exp $
...
\def\pgfdeclarearrow#1{%
  ...
  \else%
    ...
    \ifx\pgf@decl@arrow@code\pgfutil@empty%
    ...
    \else%
      ...
      \else%
        \pgferror{An arrow declaration cannot be both a meta arrow and a shorthand}
      \fi%
    \fi%
  \fi%
}
...
\pgfdeclarearrow{ name = To } % forward declaration
\pgfdeclarearrow{ name = Bar } % forward declaration
\pgfkeys{
  <-> /.tip           = {To},
  >-< /.tip           = {>[reversed]},
  | /.tip             = {Bar}
