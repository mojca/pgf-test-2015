...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorearrows.code.tex,v 1.19 2013/09/17 20:22:03 tantau Exp $
...
\def\pgfarrows@initial@parser{%
  \let\pgf@arrows@options@original\pgf@arrows@options%
...
\def\pgf@arrows@parser@done#1{%
  \let\pgf@arrows@options\pgf@arrows@options@original%
}
