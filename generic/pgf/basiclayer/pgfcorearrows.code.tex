...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorearrows.code.tex,v 1.22 2013/09/17 22:00:21 tantau Exp $
...
% bendable    = Defaults to true. If false, the arrow will never bend,
%               even when the bend option is set. This is useful for
%               instance with arrows made from text.
...
\pgfkeys{
  ...
  bendable/.is if=pgf@decl@arrow@bendable,
...
\newif\ifpgf@decl@arrow@bendable
...
\pgfkeys{
  ...
  inset/.code={%
    \pgfarrowsthreeparameters{#1}%
    \expandafter\pgfarrowsaddtooptions\expandafter{\expandafter\pgfarrowslinewidthdependent\pgfarrowstheparameters\pgfarrowinset\pgf@x}%
  },
  inset'/.code={
    \pgfarrowsthreeparameters{#1}%
  ...
  width/.code={%
    \pgfarrowsthreeparameters{#1}%
    \expandafter\pgfarrowsaddtooptions\expandafter{\expandafter\pgfarrowslinewidthdependent\pgfarrowstheparameters\pgfarrowwidth\pgf@x}%
  },
  width'/.code={%
    \pgfarrowsthreeparameters{#1}%
  ...
  degrees/.code=\pgfarrowsaddtooptions{\def\pgfarrowdegrees{#1}},
  sep/.code={
    \pgfarrowsthreeparameters{#1}%
...
\def\pgf@arrow@fullname#1{pgf@@ar@#1@\the\pgflinewidth @\pgfinnerlinewidth @\ifpgfarrowreversed r\fi @\csname pgf@ar@par@#1\endcsname}
...
% A "Bar" arrow, which is just a line orthogonal to the line.
...
\pgfdeclarearrow{
  ...
  setup = {
    ...
    % The hull:
    \pgfarrowshullpoint{.5\pgflinewidth}{.5\pgfarrowwidth}%
    \pgfarrowshullpoint{-.5\pgflinewidth}{.5\pgfarrowwidth}%
    \ifpgfarrowharpoon
      \pgfarrowshullpoint{.5\pgflinewidth}{0pt}%
    \else
      \pgfarrowshullpoint{.5\pgflinewidth}{-.5\pgfarrowwidth}%
      \pgfarrowshullpoint{-.5\pgflinewidth}{-.5\pgfarrowwidth}%
    \fi
  ...
  code = {
    \pgfsetdash{}{+0pt}
    \pgfsetbuttcap
    \pgfpathmoveto{\pgfqpoint{0pt}{\ifpgfarrowharpoon-.5\pgflinewidth\else-.5\pgfarrowwidth\fi}}
...
\pgfdeclarearrow{
  ...
  setup = {
    ...
    \pgfarrowshullpoint{0pt}{\ifpgfarrowharpoon-.5\pgflinewidth\else-.5\pgfarrowwidth\fi}%
  },
  code = {
    \ifpgfarrowharpoon \pgftransformyshift{+-.5\pgflinewidth} \fi
    \pgfpathmoveto    {\pgfqpoint{\pgfarrowlength}{0pt}}
    \pgfpathcurveto   {\pgfqpoint{.73333\pgfarrowlength}{.0666666\pgfarrowwidth}}
                      {\pgfqpoint{.3\pgfarrowlength}{.2666666\pgfarrowwidth}}
                      {\pgfqpoint{0pt}{.5\pgfarrowwidth}}
    \pgfpathlineto    {\pgfqpoint{0pt}{-.5\pgfarrowwidth}}
    \ifpgfarrowharpoon
      \pgfpathlineto  {\pgfpointorigin}
    \else  
      \pgfpathcurveto {\pgfqpoint{.3\pgfarrowlength}{-.2666666\pgfarrowwidth}}
                      {\pgfqpoint{.73333\pgfarrowlength}{-.0666666\pgfarrowwidth}}
...
\pgfdeclarearrow{
  ...
  setup = {
    ...
    % Infos:
    \pgfarrowssettipend{\pgfarrowlength}
    \pgfarrowssetlineend{\pgfarrowinset\ifpgfarrowreversed\advance\pgf@x by.5\pgflinewidth\fi}
...
\pgfkeys {
  ...
  space /.tip                  = {_},
  to reversed /.tip            = {Classical TikZ Rightarrow[reversed]},
  left to /.tip                = {Classical TikZ Rightarrow[harpoon]},
  right to /.tip               = {Classical TikZ Rightarrow[harpoon,swap]},
  left to reversed /.tip       = {Classical TikZ Rightarrow[harpoon,reversed]},
  right to reversed /.tip      = {Classical TikZ Rightarrow[harpoon,swap,reversed]},
  stealth /.tip                = {Stealth},
