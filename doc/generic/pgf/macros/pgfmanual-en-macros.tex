...
% $Header: /cvsroot/pgf/pgf/doc/generic/pgf/macros/pgfmanual-en-macros.tex,v 1.51 2011/05/02 17:09:24 jannis-pohlmann Exp $
...
\newenvironment{gdalgorithm}[1]{
  \begin{pgfmanualentry}
    ...
    \vspace{-3pt}\item{\small {\ttfamily/graph drawing/#1=}\meta{options}}\vspace{-2pt}\par
    \vspace{-3pt}\item{\small alias {\ttfamily/tikz/#1}}\vspace{-2pt}\par
    \vspace{-3pt}\item{\small alias {\ttfamily/tikz/graphs/#1}}\vspace{-2pt}\par
    \pgfmanualpdflabel{#1}{}%
    \pgfmanualbody
}
{
