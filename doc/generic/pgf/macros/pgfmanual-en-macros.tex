...
% $Header: /cvsroot/pgf/pgf/doc/generic/pgf/macros/pgfmanual-en-macros.tex,v 1.62 2012/05/23 21:02:07 tantau Exp $
...
\newenvironment{luatable}[2]{
  \luageneric{#1}{#2}{}{Lua table}
}{\endluageneric}

\newenvironment{luanamespace}[2]{
  \luageneric{#1}{#2}{}{Lua namespace}
}{\endluageneric}
...
\def\parameteritem@[#1]{\def\test{#1}\ifx\test\pgfutil@empty\else\kern1em\textbullet\ #1\kern.5em\fi}
