...
% $Header: /cvsroot/pgf/pgf/doc/generic/pgf/macros/pgfmanual-en-macros.tex,v 1.57 2012/03/21 19:48:36 tantau Exp $
...
\renewcommand*\l@subsubsection{\@dottedtocline{3}{4.8em}{3.7em}}
...
\newenvironment{gdalgorithm}[2]{
  \begin{pgfmanualentry}
    ...
    \item{\small Algorithm(s) used by this layout: {\ttfamily#2}}\par
    \pgfmanualpdflabel{#1}{}%
    \pgfmanualbody
}
{
