...
% $Header: /cvsroot/pgf/pgf/doc/generic/pgf/macros/pgfmanual-en-macros.tex,v 1.60 2012/05/14 10:27:46 tantau Exp $
...
\newenvironment{luageneric}[4]{
  \pgfmanualentry
    \pgfmanualentryheadline{Lua #4 \texttt{#1\declare{#2}}#3}
...
\newenvironment{luatable}[2]{
  \luageneric{#1}{#2}{}{table}
}{\endluageneric}

\newenvironment{luaclass}[2]{
  \luageneric{#1}{#2}{}{class}
}{\endluageneric}

\newenvironment{luanamespace}[2]{
  \luageneric{#1}{#2}{}{namespace}
}{\endluageneric}
